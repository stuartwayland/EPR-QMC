...
Let’s try the natural ideas one by one.

Idea 1: Local basis rotations

Rotate each edge term:
Z_i Z_j \;\mapsto\; X_i X_j

But:
	•	X_i X_j still maps to quartic fermionic operators
	•	Only X_i X_{i+1} + Y_i Y_{i+1} is quadratic

So single Pauli products are not enough — you need paired terms.
